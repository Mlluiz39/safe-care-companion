...
const FamilyMembers = () => {
  ...
  const handleFormSubmit = async (values: any) => {
    ...
    const memberData = {
      ...
      chronic_conditions:
        values.chronic_conditions.length > 0 ? values.chronic_conditions : null,
      ...
      <header className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 flex items-center justify-between gap-2">
          <div className="flex items-center gap-1 sm:gap-2 min-w-0">
            ...
            <div className="flex items-center gap-1 sm:gap-2 min-w-0">
              <Users className="w-5 h-5 sm:w-8 sm:h-8 text-primary shrink-0" />
              <h1 className="text-sm sm:text-xl font-bold truncate">Membros da Família</h1>
            </div>
          </div>
          <Button
            onClick={() => {
              ...
              editingMember
                ? {
                    ...
                    date_of_birth: editingMember.date_of_birth
                      ? new Date(editingMember.date_of_birth)
                      : undefined,
